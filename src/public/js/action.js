    ...
    button.addEventListener("click", function () {
      ...
      if (formIsValid) {
        ...
        if (paymentMethod === "momo") {
          ...
          const networkInvalidElement = document.getElementById(
            "network_validate_message"
          );
          ...
          const validateCardExpiry =
            validateExpiryDate(formObject.expirationDate) &&
...
function getCartitems() {
  ...
  if (!cartItems.length) {
    ...
    listItem3.className =
      "list-group-item d-flex justify-content-between lh-sm";
    const emptyCart = `<div class=''>Empty cart </div>`;
  ...
  if (cartItems.length && !payForm) {
    ...
    listItem2.className =
      "list-group-item d-flex justify-content-between lh-sm";
    const checkoutBtn = `<a href="/?do_payment=true"><button  id="submitForm" class="w-100 mt-2 btn btn-primary btn-lg text-white text-decoration-none" type="submit"><span style="color:white"> Checkout </span></buttton></a>`;
  ...
  if (!cartItems.length && submitForm) {
    ...
    listItem4.className =
      "list-group-item d-flex justify-content-between lh-sm";
    const backBtnn = `<a class=" text-decoration-none" href="/"><button  class="w-100 mt-2 btn btn-secondary btn-lg text-white" type="button"><span style="color:white"> Back To Products Page </span></buttton></a>`;
